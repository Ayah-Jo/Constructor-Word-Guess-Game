...
// Game Possible Words
let randomWords = require("./randomwords")

// Create the game Word with a randomly chosen Word
// let myWord = new Word("Cat");
let myWord = new Word(randomWords[Math.floor(Math.random() * randomWords.length)]);

// This letiable store the Number of Chances
let chances = 10;
...
function play() {
  ...
  inquirer.prompt([
    ...
    let guessed = myWord.charIsIn(answers.charGuess);
